...
export default function Desart() {
  const router = useRouter();
  const categoryId = CategoryId.Desart;

  const desartProducts = getProductsByCategory(categoryId);

  if (desartProducts.length === 0) {
    return (
