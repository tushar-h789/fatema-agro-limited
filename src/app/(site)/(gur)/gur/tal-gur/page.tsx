...
export default function GurProducts() {
  ...
  const subCategoryId = SubCategoryId.PalmJaggery;

  const gurProducts = getProductsBySubCategory(subCategoryId);
  ...
  const handleCardClick = (id: string) => {
    router.push(`/gur/tal-gur/${id}`); // Navigate to product details page
  };
