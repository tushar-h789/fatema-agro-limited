      ...
      <Card className="shadow-md mt-8 border border-gray-200 rounded-lg">
        <CardContent className="p-6">
          ...
          <p className="text-gray-700 leading-relaxed text-lg mb-4">
            ...
            হাতের নাগালে। ছাগলের মাংস সরাসরি আমাদের নির্ভরযোগ্য খামার থেকে
            সংগ্রহ করা হয় এবং পেশাদারীভাবে প্রস্তুত করা হয়, যাতে আপনি পেয়ে যান
            অত্যন্ত সুস্বাদু এবং স্বাস্থ্যকর মাংস।
            <br /> ঘরে বসে অর্ডার করুন এবং উপভোগ করুন সেরা গুণমানের দেশি ছাগলের
            মাংস।
          </p>
          {/* Description */}
          <p className="text-gray-600 leading-relaxed mb-4">
            আমাদের দেশি ছাগলের মাংস ১০০% খাঁটি এবং রাসায়নিক মুক্ত। এটি উচ্চ
            গুণমানের, স্বাস্থ্যকর এবং পুষ্টিকর, যা আপনার সারা দিনের প্রয়োজনীয়
            প্রোটিন এবং পুষ্টি সরবরাহ করবে। আমরা দেশি ছাগল মাংস সংগ্রহ করি
            আমাদের নির্ভরযোগ্য খামার থেকে, যেখানে পশুদের প্রাকৃতিক ও
            স্বাস্থ্যসম্মতভাবে পোষণ করা হয়।
          </p>
          <p>
          ...
          <div className="mt-6">
            ...
            <ul className="list-decimal list-inside text-gray-700 leading-relaxed">
              <li>
                <strong>প্রোটিনের উৎস:</strong> দেশি ছাগলের মাংস উচ্চমানের
                প্রোটিন সরবরাহ করে, যা পেশী গঠন এবং শরীরের অন্যান্য গুরুত্বপূর্ণ
                কাজের জন্য উপকারী।
              </li>
              <li>
                <strong>রক্তের আয়রন:</strong> ছাগলের মাংসে থাকা আয়রন রক্তের
                সঞ্চালন বাড়ায় এবং অ্যানিমিয়া প্রতিরোধে সাহায্য করে।
              </li>
              <li>
                <strong>বৃদ্ধি উন্নয়ন:</strong> শিশুর বৃদ্ধি এবং উন্নয়ন জন্য
                দেশি ছাগলের মাংস অত্যন্ত উপকারী।
              </li>
              <li>
                <strong>হৃদরোগের ঝুঁকি কমানো:</strong> দেশি ছাগলের মাংসে থাকা
                Omega-3 ফ্যাটি অ্যাসিড হৃদরোগের ঝুঁকি কমাতে সাহায্য করে।
              </li>
              <li>
                <strong>চর্মের স্বাস্থ্য:</strong> ছাগলের মাংসে থাকা ভিটামিন B12
                ত্বকের স্বাস্থ্যের জন্য উপকারী।
              </li>
              <li>
                <strong>শক্তিশালী হাড়:</strong> দেশি ছাগলের মাংসে উপস্থিত
                ক্যালসিয়াম এবং ফসফরাস হাড় শক্তিশালী করতে সাহায্য করে।
              </li>
              <li>
              ...
              <li>
                <strong>অ্যান্টি-অক্সিডেন্ট:</strong> ছাগলের মাংসে থাকা
                সেলেনিয়াম এবং জিঙ্ক উপাদান অ্যান্টি-অক্সিডেন্ট হিসেবে কাজ করে।
              </li>
              <li>
                <strong>মাংসপেশীর তন্তু:</strong> ছাগলের মাংস শরীরে শক্তি
                যোগানোর পাশাপাশি পেশীগুলিকে মজবুত করে।
              </li>
              <li>
