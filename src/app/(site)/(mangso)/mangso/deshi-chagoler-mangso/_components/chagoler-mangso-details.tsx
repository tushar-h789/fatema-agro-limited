...
export default function ChagolerMangsoDetails({
  product,
  relatedProducts,
  ...
  useEffect(() => {
    setBasePrice(1000); // Default base price for 1L mustard oil
  }, [product]);
  ...
  const handleVolumeChange = (volume: string) => {
    ...
    if (volume === "1kg") setBasePrice(1000);
    else if (volume === "2kg") setBasePrice(1990);
    else if (volume === "5kg") setBasePrice(4950);

    setQuantity(1); // Reset quantity when changing volume
  };

  const handleNavigateToDetails = (id: string) => {
    router.push(`/mangso/deshi-chagoler-mangso/${id}`);
  };
            ...
            <div>
              ...
              <ul className="space-y-2 mt-4">
                <li>
                  ...
                  আপনাদের জন্য এনেছে সম্পূর্ণ প্রাকৃতিক ও ভেজালমুক্ত দেশি ছাগলের
                  মাংস। আমাদের ছাগলের মাংস শতভাগ হালাল এবং স্বাস্থ্যসম্মত।
                </li>
                <li>
                  📲 অর্ডার করতে আমাদের{" "}
                  <span>
  ...
  <CardContent className="p-6">
    ...
    <p className="text-gray-700 leading-relaxed text-lg mb-4">
      খাঁটি দেশি ছাগলের মাংস{" "}
      <strong className="text-primary">Fatema Agro</strong> থেকে এখন আপনার
      হাতের নাগালে। ছাগলের মাংস সরাসরি আমাদের নির্ভরযোগ্য খামার থেকে সংগ্রহ
      করা হয় এবং পেশাদারীভাবে প্রস্তুত করা হয়, যাতে আপনি পেয়ে যান অত্যন্ত
      সুস্বাদু এবং স্বাস্থ্যকর মাংস।
      <br /> ঘরে বসে অর্ডার করুন এবং উপভোগ করুন সেরা গুণমানের দেশি ছাগলের মাংস।
    </p>
    {/* Description */}
    <p className="text-gray-600 leading-relaxed mb-4">
      আমাদের দেশি ছাগলের মাংস ১০০% খাঁটি এবং রাসায়নিক মুক্ত। এটি উচ্চ গুণমানের,
      স্বাস্থ্যকর এবং পুষ্টিকর, যা আপনার সারা দিনের প্রয়োজনীয় প্রোটিন এবং
      পুষ্টি সরবরাহ করবে। আমরা দেশি ছাগল মাংস সংগ্রহ করি আমাদের নির্ভরযোগ্য
      খামার থেকে, যেখানে পশুদের প্রাকৃতিক ও স্বাস্থ্যসম্মতভাবে পোষণ করা হয়।
    </p>
    <p>
      আমাদের দেশি ছাগলের মাংস{" "}
      <span className="font-semibold text-primary">রাজশাহী এবং নওগাঁ</span>{" "}
    ...
    <div className="mb-4">
      <h3 className="text-xl font-semibold mb-2 text-gray-800">
        কেন আমাদের দেশি ছাগলের মাংস নিবেন?
      </h3>
      <p>
        আমরা সরবরাহ করছি একদম খাঁটি এবং স্বাস্থ্যসম্মত দেশি ছাগলের মাংসের
        নিশ্চয়তা। <br />
        <ul className="list-disc list-inside text-gray-700 leading-relaxed">
          <li>আমাদের মাংস ১০০% খাঁটি এবং রাসায়নিক মুক্ত।</li>
          <li>
            দেশি ছাগল খামারে সুস্থভাবে পালিত পশু থেকে সংগ্রহ করা হয়।
          </li>
      ...
      <ul className="list-disc list-inside text-gray-600 leading-relaxed">
        ...
        <li>✅ প্রাকৃতিক এবং টাটকা দেশি ছাগলের মাংস।</li>
    ...
    <div className="mt-6">
      <h3 className="text-xl font-semibold mb-4 text-gray-800">
        দেশি ছাগলের মাংসের ১২টি উপকারিতা যা অনেকেরই অজানা:
      </h3>
      <ul className="list-decimal list-inside text-gray-700 leading-relaxed">
        <li>
          <strong>প্রোটিনের উৎস:</strong> দেশি ছাগলের মাংস উচ্চমানের প্রোটিন
          সরবরাহ করে, যা পেশী গঠন এবং শরীরের অন্যান্য গুরুত্বপূর্ণ কাজের জন্য
          উপকারী।
        </li>
        <li>
          <strong>রক্তের আয়রন:</strong> ছাগলের মাংসে থাকা আয়রন রক্তের সঞ্চালন
          বাড়ায় এবং অ্যানিমিয়া প্রতিরোধে সাহায্য করে।
        </li>
        <li>
          <strong>বৃদ্ধি উন্নয়ন:</strong> শিশুর বৃদ্ধি এবং উন্নয়ন জন্য দেশি
          ছাগলের মাংস অত্যন্ত উপকারী।
        </li>
        <li>
          <strong>হৃদরোগের ঝুঁকি কমানো:</strong> দেশি ছাগলের মাংসে থাকা Omega-3
          ফ্যাটি অ্যাসিড হৃদরোগের ঝুঁকি কমাতে সাহায্য করে।
        </li>
        <li>
          <strong>চর্মের স্বাস্থ্য:</strong> ছাগলের মাংসে থাকা ভিটামিন B12 ত্বকের
          স্বাস্থ্যের জন্য উপকারী।
        </li>
        <li>
          <strong>শক্তিশালী হাড়:</strong> দেশি ছাগলের মাংসে উপস্থিত ক্যালসিয়াম
          এবং ফসফরাস হাড় শক্তিশালী করতে সাহায্য করে।
        </li>
        <li>
          <strong>এনার্জি প্রদান:</strong> ছাগলের মাংস শরীরের এনার্জি স্তর
          বজায় রাখতে সহায়ক।
        </li>
        <li>
          <strong>মাংসপেশীর উন্নয়ন:</strong> ছাগলের মাংসে প্রোটিন থাকায়
          মাংসপেশী গঠন ও উন্নতি সহজ হয়।
        </li>
        <li>
          <strong>অ্যান্টি-অক্সিডেন্ট:</strong> ছাগলের মাংসে থাকা সেলেনিয়াম এবং
          জিঙ্ক উপাদান অ্যান্টি-অক্সিডেন্ট হিসেবে কাজ করে।
        </li>
        <li>
          <strong>মাংসপেশীর তন্তু:</strong> ছাগলের মাংস শরীরে শক্তি যোগানোর
          পাশাপাশি পেশীগুলিকে মজবুত করে।
        </li>
        <li>
          <strong>ডায়াবেটিস নিয়ন্ত্রণ:</strong> ছাগলের মাংসের কিছু উপাদান
          ডায়াবেটিস নিয়ন্ত্রণে সহায়তা করে।
        </li>
        <li>
          <strong>দৃষ্টিশক্তি:</strong> ছাগলের মাংসে উপস্থিত ভিটামিন A
    ...
    <div className="mt-6">
      <h3 className="text-xl font-semibold mb-4 text-gray-800">
        আমাদের দেশি ছাগলের মাংসের বৈশিষ্ট্য:
      </h3>
      <ul className="list-disc list-inside text-gray-700 leading-relaxed">
        <li>🌴 খাঁটি দেশি ছাগলের মাংস, কোন ভেজাল নেই।</li>
        <li>🌴 স্বাস্থ্যকর এবং পুষ্টিকর মাংস।</li>
        <li>🌴 সাশ্রয়ী মূল্য এবং দ্রুত ডেলিভারি সেবা।</li>
        <li>🌴 ১০০% কেমিক্যাল মুক্ত মাংস।</li>
        <li>🌴 প্রাকৃতিক এবং তাজা দেশি ছাগলের মাংস।</li>
