...
export default function GorurMangsoDetails({
          ...
          <div className="flex flex-col justify-between md:w-1/2">
            ...
            <div className="mt-6">
              <h2 className="text-lg">
                ...
                |
                <span className="text-primary font-semibold">
                  <Link href="/mangso/deshi-chagoler-mangso"> ছাগলের মাংস </Link>
                </span>
                |
                <span className="text-primary font-semibold">
  ...
  <CardContent className="p-6">
    ...
    <p className="text-gray-700 leading-relaxed text-lg mb-4">
      ...
      হাতের নাগালে। গরুর মাংস সরাসরি আমাদের নির্ভরযোগ্য খামার থেকে
    ...
    <div className="mb-4">
      ...
      <p>
        আমরা সরবরাহ করছি একদম খাঁটি এবং স্বাস্থ্যসম্মত গরুর মাংসের নিশ্চয়তা।{" "}
        <br />
        <ul className="list-disc list-inside text-gray-700 leading-relaxed">
          <li>আমাদের মাংস ১০০% খাঁটি এবং রাসায়নিক মুক্ত।</li>
          <li>গরুর মাংস খামারে সুস্থভাবে পালিত পশু থেকে সংগ্রহ করা হয়।</li>
    ...
    <div className="mt-6">
      ...
      <ul className="list-decimal list-inside text-gray-700 leading-relaxed">
        ...
        <li>
          <strong>রক্তের আয়রন:</strong> গরুর মাংসে থাকা আয়রন রক্তের সঞ্চালন
          বাড়ায় এবং অ্যানিমিয়া প্রতিরোধে সাহায্য করে।
        </li>
        <li>
          <strong>বৃদ্ধি উন্নয়ন:</strong> শিশুর বৃদ্ধি এবং উন্নয়ন জন্য গরুর
          মাংস অত্যন্ত উপকারী।
        </li>
        <li>
        ...
        <li>
          <strong>শক্তিশালী হাড়:</strong> গরুর মাংসে উপস্থিত ক্যালসিয়াম এবং
          ফসফরাস হাড় শক্তিশালী করতে সাহায্য করে।
        </li>
        <li>
        ...
        <li>
          <strong>ডায়াবেটিস নিয়ন্ত্রণ:</strong> গরুর মাংসের কিছু উপাদান ডায়াবেটিস
          নিয়ন্ত্রণে সহায়তা করে।
        </li>
        <li>
          <strong>দৃষ্টিশক্তি:</strong> গরুর মাংসে উপস্থিত ভিটামিন A দৃষ্টিশক্তি
          বাড়াতে সাহায্য করে।
        </li>
      </ul>
    </div>
