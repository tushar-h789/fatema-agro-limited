...
export default function MurgirMangsoDetails({
  ...
  <CardContent className="p-6">
    ...
    <p className="text-gray-700 leading-relaxed text-lg mb-4">
      ...
      হাতের নাগালে। আমাদের দেশি মুরগির মাংস সরাসরি আমাদের নির্ভরযোগ্য খামার থেকে সংগ্রহ করা হয় এবং পেশাদারীভাবে প্রস্তুত করা হয়, যাতে আপনি পেয়ে যান সুস্বাদু এবং স্বাস্থ্যকর মাংস।
      <br /> ঘরে বসে অর্ডার করুন এবং উপভোগ করুন সেরা গুণমানের দেশি মুরগির মাংস।
    </p>
    {/* Description */}
    <p className="text-gray-600 leading-relaxed mb-4">
      আমাদের দেশি মুরগির মাংস ১০০% খাঁটি এবং রাসায়নিক মুক্ত। এটি উচ্চ গুণমানের, স্বাস্থ্যকর এবং পুষ্টিকর, যা আপনার সারা দিনের প্রয়োজনীয় প্রোটিন এবং পুষ্টি সরবরাহ করবে। আমরা দেশি মুরগি সংগ্রহ করি আমাদের নির্ভরযোগ্য খামার থেকে, যেখানে মুরগিগুলো প্রাকৃতিক ও স্বাস্থ্যসম্মতভাবে পালিত হয়।
    </p>
    <p>
    ...
    <p className="font-semibold">
      *আর পিউরিটি নিয়ে নিশ্চয়তা দিচ্ছে FATEMA AGRO কোন প্রোডাক্টে অভিযোগ থাকলে আমাদের কে জানালে আমরা ফুল টাকা রিফান্ড করে দিব।
    </p>
    {/* Why Buy Section */}
    <div className="mb-4">
      ...
      <p>
        আমরা সরবরাহ করছি একদম খাঁটি এবং স্বাস্থ্যসম্মত দেশি মুরগির মাংসের নিশ্চয়তা।
        <br />
    ...
    <div className="mt-6">
      ...
      <ul className="list-decimal list-inside text-gray-700 leading-relaxed">
        <li>
          <strong>প্রোটিনের উৎস:</strong> দেশি মুরগির মাংস উচ্চমানের প্রোটিন
          সরবরাহ করে, যা পেশী গঠন এবং শরীরের অন্যান্য গুরুত্বপূর্ণ কাজের জন্য উপকারী।
        </li>
        <li>
          <strong>স্বাস্থ্যকর ফ্যাট:</strong> দেশি মুরগির মাংসে স্বাস্থ্যকর ফ্যাট থাকে, যা আপনার হৃদরোগের ঝুঁকি কমাতে সাহায্য করে।
        </li>
        <li>
          <strong>ভিটামিন B12:</strong> দেশি মুরগির মাংসে উপস্থিত ভিটামিন B12 ত্বকের এবং স্নায়ুতন্ত্রের স্বাস্থ্যের জন্য উপকারী।
        </li>
        <li>
          <strong>শক্তিশালী হাড়:</strong> মুরগির মাংসে উপস্থিত ক্যালসিয়াম এবং ফসফরাস হাড় শক্তিশালী করতে সাহায্য করে।
        </li>
        <li>
          <strong>এনার্জি প্রদান:</strong> দেশি মুরগির মাংস শরীরের এনার্জি স্তর বজায় রাখতে সহায়ক।
        </li>
        <li>
          <strong>ডায়াবেটিস নিয়ন্ত্রণ:</strong> দেশি মুরগির মাংসে উপস্থিত উপাদান ডায়াবেটিস নিয়ন্ত্রণে সহায়তা করে।
        </li>
        <li>
          <strong>হৃদরোগের ঝুঁকি কমানো:</strong> মুরগির মাংসে থাকা Omega-3 ফ্যাটি অ্যাসিড হৃদরোগের ঝুঁকি কমাতে সাহায্য করে।
        </li>
        <li>
          <strong>ওজন নিয়ন্ত্রণ:</strong> দেশি মুরগির মাংসে কম ক্যালোরি থাকে, যা ওজন নিয়ন্ত্রণে সহায়তা করে।
        </li>
        <li>
          <strong>পেশী গঠন:</strong> মুরগির মাংসে প্রোটিন থাকায় মাংসপেশী গঠন ও উন্নতি সহজ হয়।
        </li>
        <li>
          <strong>কোলেস্টেরল কমানো:</strong> মুরগির মাংসে উপস্থিত উপাদান কোলেস্টেরল কমাতে সাহায্য করে।
        </li>
      </ul>
    </div>
